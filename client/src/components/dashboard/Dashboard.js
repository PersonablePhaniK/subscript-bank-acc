      ...
      dashboardContent = (
        <div className="row">
          <div className="col s12 center-align">
            ...
            <div>
              <PlaidLinkButton 
                ...
                plaidLinkProps={{
                  ...
                  key: "80329a65b5399fe0cb589670ad120c",
                  env: "sandbox",
            ...
            <button onClick={this.onLogoutClick} className="btn btn-large waves-effect waves-light hoverable red accent-3 main-btn">Logout</button>
          </div>
        </div>
      )
    }
